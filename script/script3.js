...
function subject(event,subject){
    ...
    if (!isNaN(quiz)) {
        ...
        localStorage.setItem(`${subject}Quiz3`,quizScore);
    ...
    if  (!isNaN(assign)) {
        ...
        localStorage.setItem(`${subject}Assign3`,assignScore);
    ...
    if (!isNaN(recite)) {
        ...
        localStorage.setItem(`${subject}Recite3`,reciteScore);
    ...
    if (!isNaN(proj) ) {
        ...
        localStorage.setItem(`${subject}Proj3`,projScore);
    ...
    if (!isNaN(attend) ) {
        ...
        localStorage.setItem(`${subject}Attend3`,attendScore);
    ...
    if (!isNaN(exam)) {
        ...
        localStorage.setItem(`${subject}Exam3`,examScore);
...
function displayGradeScore(subject,activity){
    ...
    if (subjectText){
        return score = subjectText.textContent = localStorage.getItem((`${subject}${activity}3`));
    };
};
