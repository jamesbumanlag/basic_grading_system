...
function subject(event,subject){
    ...
    if (!isNaN(quiz)) {
        ...
        localStorage.setItem(`${subject}Quiz4`,quizScore);
    ...
    if  (!isNaN(assign)) {
        ...
        localStorage.setItem(`${subject}Assign4`,assignScore);
    ...
    if (!isNaN(recite)) {
        ...
        localStorage.setItem(`${subject}Recite4`,reciteScore);
    ...
    if (!isNaN(proj) ) {
        ...
        localStorage.setItem(`${subject}Proj4`,projScore);
    ...
    if (!isNaN(attend) ) {
        ...
        localStorage.setItem(`${subject}Attend4`,attendScore);
    ...
    if (!isNaN(exam)) {
        ...
        localStorage.setItem(`${subject}Exam4`,examScore);
...
function displayGradeScore(subject,activity){
    ...
    if (subjectText){
        return score = subjectText.textContent = localStorage.getItem((`${subject}${activity}4`));
    };
};
